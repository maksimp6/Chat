...
TERMUX_TOOLS = {
    ...
    "termux_battery_status": {
        ...
        "parameters": {
            "type": "object",
            "properties": {"dummy": {"type": "string", "description": "unused"}},
            "required": [],
        },
    },
    "termux_toast": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "message": {"type": "string", "description": "Текст всплывающего уведомления"}
            },
            "required": ["message"],
        },
    },
    "termux_vibrate": {
        ...
        "parameters": {
            ...
            "properties": {
                "duration_ms": {
                    "type": "integer",
                    "description": "Длительность вибрации в миллисекундах (по умолчанию 500)",
                }
            },
            "required": [],
        },
    ...
    "termux_clipboard_set": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "text": {"type": "string", "description": "Текст для помещения в буфер"}
            },
            "required": ["text"],
        },
    },
