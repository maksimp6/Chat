(function () {
  ...
  function clearWaveform() {
    ...
    waveCtx.fillStyle =
      getComputedStyle(document.documentElement).getPropertyValue("--bg-input") || "#f0f0f5";
  ...
  async function toggleVoice() {
    ...
    var modelKey =
      (typeof currentModel !== "undefined" ? currentModel : "speech-realtime-260528") ||
    ...
    try {
      var res = await window.AliceDispatcher.request("/api/voice/session", {
        ...
        body: JSON.stringify({
          ...
          response_mode: document.getElementById("response-mode-select")
            ? document.getElementById("response-mode-select").value
            : "audio",
        }),
      });
