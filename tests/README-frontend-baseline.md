...
For the severe network baseline—10 KiB/s download, **0.065 KiB/s upload**, and 2500 ms additional latency—run the Python probe directly:
...
The upload value is `0.26 / 2 / 2 = 0.065 KiB/s`.
