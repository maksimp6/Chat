...
if (document.getElementById("dynamic-modal") !== dynamic) throw new Error("dynamic DOM insertion broken");
if (dynamic.querySelectorAll(".modal-content").length !== 1) throw new Error("querySelectorAll broken");
if (dynamic.querySelector("button").textContent !== "Close") throw new Error("innerHTML parsing broken");
if (dynamic.querySelector("span").textContent !== "Тест UTF-8") throw new Error("UTF-8 DOM text broken");
