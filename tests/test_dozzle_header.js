...
if (!html.includes('id="dozzle-btn"') || !html.includes('data-action="header.dozzle.open"')) throw new Error("Dozzle declarative action missing");
if (!header.includes('actions.register("header.dozzle.open", call("openDozzleLogs"))')) throw new Error("Dozzle dispatcher registration missing");
